...
function addClient() {
    ...
    var countEmpty = 0;
    $("#add_client_form input").each(function(index, element) {
...
function edit(id) {
    ...
    $.get(`controller/client.actions.php`, data,
        function(data) {
            if (data == "true") {
                swal("Hecho", `La informacion ha sido editada`, "success");
...
$(document).on("click", ".addClient_btn", function() {
    //añadir cliente
...
$("#client").keyup(function(e) {
    //consulta para cargar la informacion de un cliente en la pantalla de inicio
    var q = e.target.value

    $.get(`controller/client.actions.php?search=${q}`,
        function(data) {

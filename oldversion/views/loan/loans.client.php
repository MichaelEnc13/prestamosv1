...
<span class="client_prest">
   ...
   <?php else:?>
    <b>No has selecionado ningún cliente</b>
   <?php endif;?>
</span>
    ...
    <div class="loan" id="loan_<?php echo $loan['prest_id']?>">
     ...
     <!--    <span class="arriers">
        ...
        <div class="loan_controls">            
            ...
            <button onclick="applyPayment(<?php echo $loan['prest_id']?>,<?php echo $loan['client_id']?>)">
                Abonar
            </button>
            ...
            <button  class="viewTicketBtn" id="<?php echo $loan['prest_id']?>" > Recibos del préstamo</button>

...
<div class="applyPay actions_loans_forms" id="applyPay_<?php echo $loan['prest_id']?>">
    ...
    <form id="applyPaid_form" onsubmit="return false;">
        ...
        <?php endif;?>
        <span>Total estimado a cobrar: DOP $ <span id="estimated_amount_content"><?php echo number_format($amountDues + $arrier) ?></span></span>
        <input type="hidden" id="estimated_amount" value="<?php echo $amountDues + $arrier ?>">

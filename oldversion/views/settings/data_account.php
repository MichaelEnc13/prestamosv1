...
<div class="data_container">
    ...
    <div class="secondInf">
        <h4 style="width:90%;font-family:var(--txt);color:white;font-size:20px;">Datos del plan</h4>
            ...
            <div class="data">
                <span>Precio</span>
                <span class="inset">US $<?php echo $_SESSION['user']['payAmount']?></span>
            </div>
            <div class="p_data">
                <div class="data">
                    <span>Fechas de pago</span>
                    <s> Días <?php echo $_SESSION['user']['days']?> de cada mes</s>
                </div>
